...
<template>
    <div class="absolute flex flex-col z-[40] w-full !max-w-full items-center justify-center bg-transparent transition-bg overflow-hidden"
        :class="className">
        <div class="ray absolute opacity-60" :class="{
            '-animate': animated,
            '-static': isStatic
        }" />
    </div>
